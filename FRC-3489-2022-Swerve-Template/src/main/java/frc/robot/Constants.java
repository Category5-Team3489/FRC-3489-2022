...
public final class Constants {
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(-54); // FIXME Measure and set front left steer offset
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(-4.7 + 180); // FIXME Measure and set front right steer offset
    ...
    public static final int BACK_LEFT_MODULE_STEER_ENCODER = 56; // FIXME Set back left steer encoder ID
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(73.2 + 180); // FIXME Measure and set back left steer offset
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(-130.3); // FIXME Measure and set back right steer offset
}
