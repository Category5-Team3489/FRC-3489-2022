...
public final class Constants {
    ...
    public static final class Shooter
    {
        ...
        public static final double[] BottomShooterSpeedAtDistanceTable = { 2500, 2670, 2800, 3150, 3350, 3575, 3400, 3200, 3250, 3000, 3250, 3500 };
        public static final double[] TopShooterSpeedAtDistanceTable = { 12500, 13700, 14500, 14580, 14900, 14820, 15000,  15000, 16750, 16000, 20000 };
