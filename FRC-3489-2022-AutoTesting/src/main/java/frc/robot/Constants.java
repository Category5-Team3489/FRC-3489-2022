...
public final class Constants {
    ...
    public static final class Shooter
    {
        ...
        public static final double[] BottomShooterSpeedAtDistanceTable = { 2800, 3000, 3250, 3450, 3250, 3250, 3500, 3500, 3000 };
        public static final double[] TopShooterSpeedAtDistanceTable = { 14500, 14500, 14500, 14750, 14500, 15000, 15500, 16000, 17500 };
