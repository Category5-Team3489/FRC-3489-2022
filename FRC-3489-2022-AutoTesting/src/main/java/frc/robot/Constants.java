...
public final class Constants {
    ...
    public static final class Shooter
    {
        ...
        public static final double[] BottomShooterSpeedAtDistanceTable = { 3200, 3000, 3000, 3000, 3250, 3575, 3400, 3000, 3250, 3000, 3250, 3500 };
        public static final double[] TopShooterSpeedAtDistanceTable = { 13400, 13700, 14500, 14500, 14500, 14900, 14820, 15000,  15600, 16750, 16000, 20000 };
